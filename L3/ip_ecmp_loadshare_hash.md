...
PATCH "<REST-SERVER:PORT>/restconf/data/openconfig-loadshare-mode-ext:ipv6/config/ipv6-dst-ip" -H "accept: */*" -H "Content-Type: application/yang-data+json" -d "{\"openconfig-loadshare-mode-ext:ipv6-dst-ip\":true}"
