...
| **Test Setup** | **Topology 1**                                               |
| **Type**       | **Functional**                                               |
| **Steps**      | 1. Breakout the port supported modes and observe the interface down reason for the port is updated as "Port breakout in-progress" during the breakout process in "show interface status" output.|
