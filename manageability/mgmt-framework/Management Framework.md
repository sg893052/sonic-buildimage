...
| 0.13 | 11/25/2019  | Sachin Holla           | RESTCONF yang library and other enhancements |
| 0.14 | 11/29/2019  | Partha Dutta           | Added new CVL API, platform and custom validation details |
...
RESTCONF root path will be "/restconf".
...
* All deviation models are compiled along with corresponding CVL YANG models and are placed in platform specific schema folder. At runtime based on detected platform from provisioned  “DEVICE_METADATA:platform” field, deviation files are applied.
