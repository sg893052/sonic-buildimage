...
# Table of Contents
  ...
  * [2 Requirements](#2-requirements)
    * [2.1 The BRIDGE-MIB requirements](#21-the-BRIDGE-MIB-requirements)
...
|:---:|:-----------:|:------------------:|-----------------------------------|
| 0.1 |             | Mohammed Faraaz C       | Initial version                   |
...
| OID                                      | SNMP counter           | Description                              | DB | Key | Value |
|------------------------------------------|------------------------|----------------------------------------------|----------|----------|---------|
| 1.3.6.1.2.1.17.7.1.1.2 | dot1qMaxVlanId | The maximum IEEE 802.1Q VLAN-ID that this device out |  |  | 4090(Fixed) |
| 1.3.6.1.2.1.17.7.1.1.3 | dot1qMaxSupportedVlans | The maximum number of IEEE 802.1Q VLANs that this device supports. |  |  | 4090(Fixed) |
